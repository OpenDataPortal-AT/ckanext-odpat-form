...
metadata_fields = [('metadata_identifier', 'Eindeutiger Identifikator', 'extras:metadata_identifier', 'show', u'Wird vom System generiert – diese ID identifiziert einen Datensatz weltweit eindeutig.', '550e8400-e29b-11d4-a716-446655441234'),
                   ('metadata_modified', 'Datum des Metadatensatzes', 'metadata_modified', 'show', u'Datum, an dem der Metadatensatz erzeugt bzw. aktualisiert wurde.', '2011-05-22'),
                   ('title', 'Titel', 'title', 'hide', u'Titel des Metadatensatzes bzw. Dokuments, Datensatzes oder Dienstes.', u'Pendlerstatistik Linz 2010'),
                   ('description', 'Beschreibung', 'notes', 'hide', 'Inhaltliche Beschreibung des Metadatensatzes bzw. Datensatzes, Dienstes oder Dokuments.', u'Hauptwohnsitzbevölkerung der Stadt Linz für das Jahr 2010 gruppiert nach Geschlecht, Alter etc.. '),
                   ('categorization', 'Kategorie', 'extras:categorization', 'show',u'Kategorisierung des Datensatzes, Dienstes oder Dokuments (Auswahl: vorgegebenes Kategorienschema für Österreich).','Gesundheit '),
                   ...
                   ('maintainer', 'Datenverantwortliche Stelle bzw. Person', 'maintainer', 'show', u'Angabe der für den Datensatz oder Dienst zuständigen Organisation bzw. Person; kann in kleinen Organisationen gleichzeitig die veröffentlichende Stelle sein. Wenn die veröffentlichende Organisation eine Einzelperson ist, ist sie auch die datenverantwortliche Stelle.', 'Magistrat Wien - Magistratsabteilung 33 - Wien Leuchtet; '),
                   ('license', 'Lizenz', 'license_title', 'show', u'Angabe der Lizenzform für den Datensatz oder den bereitgestellten Dienst, unter der die Daten genutzt werden können – auf opendatapotal.at bevorzugt: CC BY 3.0 AT.', u'Creative Commons Namensnennung 3.0 Österreich'),
                   ('begin_datetime', 'Zeitliche Ausdehnung (Anfang)', 'extras:begin_datetime', 'show', u'Beginn der Gültigkeit eines Datensatzes (oder Dienstes oder Dokuments)', '2008-12-23T22:30:12 '),
                   ('schema_name', 'Bezeichnung der Metadatenstruktur', 'extras:schema_name', 'show', u'Name der Metadatenstruktur - Wird automatisch vorausgewählt', 'OGD Austria Metadata 2.2 '),
                   ...
                   ('metadata_linkage', u'Weiterführende Metadaten', 'extras:metadata_linkage', 'show', u'Eingabe eines oder mehrerer Links zur weiterführenden Beschreibung der Metadaten.', 'http://data.wien.gv.at/pdf/wienerlinien-echtzeitdaten-dokumentation.pdf '),
                   ('attribute_description', 'Attributbeschreibung', 'extras:attribute_description', 'show', u'Angabe der verwendeten Datenfelder des Datensatzes und ihre Bedeutung.', u'ADRESSE: Adresse (Straßenname, Orientierungsnummer); OEFFNUNGSZEITEN1-6: Öffnungszeiten; TELEFON: Telefonnummer, DISTRICT_CODE: Gemeindebezirkskennzahl, ACCOUNTS_TRANSFER: Laufende Transferzahlungen '),
                   ('maintainer_link', 'Kontaktseite der datenverantwortlichen Stelle bzw. Person', 'extras:maintainer_link', 'show', u'Link oder E-Mail-Adresse der daten- bzw. dienstverantwortlichen Stelle.', 'http://www.wien.gv.at/freizeit/bildungjugend/ '),
                   ...
                   ('publisher', u'Veröffentlichende Organisation bzw. Person', 'extras:publisher', 'show', u'Benennung der zuständigen Organisation bzw. Person.', 'Land Tirol'),
                   ...
                   ('geographic_bbox', 'Geographische Ausdehnung', 'extras:geographic_bbox', 'show',u'Beschreibung der räumlichen Ausdehnung eines Datensatzes, Dienstes oder Dokuments mit einem umschreibenden Rechteck. Die Angabe erfolgt im Koordinatensystem EPSG:4326 (WGS84) mit einer Mindestgenauigkeit von zwei Dezimalstellen in einer "Well Known Text String" Repräsentation. Insgesamt müssen 5 Koordinatenpaare angegeben werden. Das erste und letzte Koordinatenpaar sind ident. Dies definiert, dass die Bounding-Box geschlossen ist. Die Koordinatenpaare werden von doppelten Klammern umschlossen.','POLYGON ((-180.00 -90.00,180.00 -90.00,180.00 90.00, -180.00 90.00, -180.00 -90.00)) '),
                   ...
                   ('en_title_and_desc', 'Titel und Beschreibung Englisch ', 'extras:en_title_and_desc', 'show', u'Titel des Datensatzes oder Dienstes und kurze inhaltliche Beschreibung des Datensatzes bzw. Dienstes für Benutzer_innen in Englisch.', 'Population of Vienna 2010. Contains the population of permanent residents of Vienna and it’s districts as a moving average in the census period 1st January 2010 to 31st December 2012 '),
